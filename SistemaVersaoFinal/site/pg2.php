...
<!--         <h1>Navbar example</h1>
      ...
      $noticia1 = $objNoticia->buscaDados($id);
      
      ?>
          <div class="row">

            <div class="col-xs-3 col-lg-3">
            <img src=<?php echo "view/imagens/". $noticia1["imagem"]; ?> align="left" style="margin: 5px; width: 200px; height: 200px">
            </div>
            <div class="col-xs-6 col-lg-9">
              <h2><?php echo $noticia1["titulo"]; ?></h2>
              <h5>Publicado em: <?php 
                  $date1 = new DateTime($noticia1["dataCadastro"]);
                  echo $date1->format('d/m/Y H:i:s'); ?> - Autor: <?php echo $noticia1["autor"]; ?></h5>
              
              <p align="justify"><?php echo $noticia1["descricao"]; ?></p>
              <p>Fonte: <?php echo $noticia1["fonte"]; ?></p>
